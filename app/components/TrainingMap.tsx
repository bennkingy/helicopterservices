    ...
    <>
      ...
      <table className="w-full border-separate border-spacing-5 sm:border-spacing-10">
        <tbody>
          <tr>
            <td>
              <div className="aspect-square	border border-gray-300 bg-slate-500 drop-shadow-brand" style={{ clipPath: 'polygon(0 0,calc(100% - 20px) 0,100% 20px,100% 100%,0 100%)' }}>
                <div className=" bg-slate-500">PPL(H)</div>
              </div>
            </td>
            <td>    <div className="aspect-square	border border-gray-300 drop-shadow-brand" style={{ clipPath: 'polygon(0 0,calc(100% - 20px) 0,100% 20px,100% 100%,0 100%)' }}>
              <div className=" ">PPL(H)</div>
            </div></td>
            <td>    <div className="aspect-square	border border-gray-300  drop-shadow-brand" style={{ clipPath: 'polygon(0 0,calc(100% - 20px) 0,100% 20px,100% 100%,0 100%)' }}>
              <div className=" ">PPL(H)</div>
            </div></td>
            ...
            <td colSpan={2} className="bg-slate-500" style={{ clipPath: 'polygon(0 0,calc(100% - 20px) 0,100% 20px,100% 100%,0 100%)' }}>

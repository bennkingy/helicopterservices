...
const FAQList: FAQProps[] = [
  ...
  },
  {
    ...
    answer: "Most students self-study which is normally sufficient, along with some assistance from their instructor. Ground school is available for any subject with which additional help is required.",
    value: "item-4",
  },
  {
    question:
      "How stringent is the medical?",
    answer:

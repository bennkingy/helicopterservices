...
export default async function About() {
  return (
    <main className="overflow-x-hidden">
      <Hero title="About Helicopter Services." height='h-[calc(100vh_-_0px)] sm:h-[calc(100vh_-_0px)]' titleMargins='mt-[162px] sm:mt-[210px]' data-id='aboutUsHero'/>
      <div className="py-20 container mx-auto grid grid-cols-1 md:grid-cols-2 relative">
        <div className='pr-0 sm:pr-20'>
          <Heading title="Making your flying experience outstanding." tag='About us' titleStyles='text-3xl sm:text-4xl' className='mb-8' data-id='aboutUsTitle' />
            <div data-id='aboutUsCopy'>
        ...
        <div className='relative col-span-1 flex justify-center mt-20 md:mt-0 :mb-0' data-id='aboutUsMedia'>
      ...
      <div className="py-20 pt-0 container mx-auto grid grid-cols-1 md:grid-cols-2 relative">
        <div className='mt-20 md:mt-0 pr-0 relative col-span-1 flex justify-center mb-20 md:mb-10' data-id='trophyMedia'>
          <FramerAnimationSlide
            items={[
              <Image
        ...
        <div className='pl-0 md:pl-10 order-first md:order-none'>
          <Heading title="The Britannia Trophy 2018." className='mb-8 mt-16 md:mt-0' titleStyles='text-3xl sm:text-4xl' data-id='trophyTitle' />
          <div data-id='trophyCopy'>
          ...
          <Image src="/images/the-royal-areo-club.png" alt="Helicopter Services" width={1000} height={1000} className='mt-10' data-id='trophyLogo' />
        </div>
      </div>

    ...
    <main className="overflow-x-hidden">
      ...
      <div className="py-20 pt-0 container mx-auto grid grid-cols-1 md:grid-cols-2 relative">
        ...
        <div className='pl-0 md:pl-10 order-first md:order-none'>
          <Heading title="The Britannia Trophy 2018." className='mb-8 mt-16 md:mt-0' titleStyles='text-3xl sm:text-4xl' />
          ...
          <Image src="/images/the-royal-areo-club.png" alt="Helicopter Services" width={1000} height={1000} className='mt-10' />
        </div>
      </div>
